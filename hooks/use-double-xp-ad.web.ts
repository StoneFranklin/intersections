        ...
        if (typeof window !== 'undefined' && (window as any).adBreak) {
          ...
          adBreak({
            ...
            adDismissed: () => {
              ...
              resolved = true;
              setIsShowing(false);
              console.log('AdSense: Double XP ad dismissed before completion');
            ...
            adViewed: () => {
              ...
              resolved = true;
              setIsShowing(false);
              console.log('AdSense: Double XP ad viewed - Reward granted!');
          ...
          console.log('AdSense not available, simulating double XP rewarded ad');
          setIsLoading(true);
          ...
          setTimeout(() => {
            ...
            setTimeout(() => {
              setIsShowing(false);
              console.log('Simulated double XP ad completed - Reward granted!');
              resolve({ success: true, rewarded: true });
            }, 3000);
          }, 500);
        }
      } catch (err) {
        console.error('Web double XP ad error:', err);
        setIsLoading(false);
        setIsShowing(false);
